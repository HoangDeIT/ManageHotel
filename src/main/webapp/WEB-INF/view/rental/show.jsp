            ...
            <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
                <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${!rental.status}">
                                                <a class="btn btn-warning mx-2"
                                                    href="rental/update/${rental.id}">Update</a>
                                                <button class="btn btn-danger delete-rental" data-bs-toggle="modal"
                                                    data-bs-target="#deleteRentalModal" data-rentalid="${rental.id}"
                                                    data-customername="${rental.id}">Delete</button>
                                                <button class="btn btn-success payment-rental" data-bs-toggle="modal"
                                                    ...
                                                    data-rentals="${totalRentals[loop.index]}">Thanh
                                                    Toán</button>
                                                <button class="btn btn-info service-rental" data-bs-toggle="modal"
                                                    data-bs-target="#addServiceModal" data-rentalid="${rental.id}">Thêm
                                                    dịch
                                                    vụ</button>
                                            </c:if>
                                        </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form id="deleteForm" action="/rental/delete" method="post">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteRentalModalLabel">Delete Rental
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Delete rental for customer: <span
                                            ...
                                            <form id="paymentForm" action="/rental/payment" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="paymentDate"
                                                        name="paymentDate" value="${formattedDate}" required />
                                                </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", () => {
                            ...
                            paymentButtons.forEach(button => {
                                ...
                                button.addEventListener('click', () => { // Lấy dữ liệu từ thuộc tính data-* của nút 
                                    ...
                                    let rentalDetails = button.getAttribute('data-rentals');
                                    document.getElementById('amount').value = rentalDetails;
                                    //paymentModal.show();
                                });
                            });
                        ...
                        document.querySelector('.payment-rental').addEventListener('click', function () {
