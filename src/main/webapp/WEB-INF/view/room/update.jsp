                        ...
                        <nav id="sidebar" class="col-lg-2 col-md-4 position-sticky">
                            ...
                            <ul class="list-unstyled components">
                                ...
                                <c:forEach var="room" items="${roomList}">
                                    <li class="${room.id == roomById.id ? 'active' : ''}">
                                        <a href="/room/update/${room.id}">${room.roomName}</a>
                                    </li>
                                </c:forEach>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-floating mb-3 col-12">
                                                        <form:input type="text" path="roomName"
                                                            class="form-control ${not empty errorRoomName ? 'is-invalid' : ''}"
                                                    ...
                                                    <div class="form-floating mb-3 col-12">
                                                        <form:input type="text" path="rentalPrice"
                                                            class="form-control ${not empty errorRentalPrice ? 'is-invalid' : ''}"
